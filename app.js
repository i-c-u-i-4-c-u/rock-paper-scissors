...
if (playerScores === 5) {
    resultTag.innerHTML = "<strong>You win this round.</strong> </br>Press a button to start new game.";

    }
 else if (compScore === 5 ){
    resultTag.innerHTML = "<strong>Computer win this round.</strong> </br>Press a button to start new game.";
